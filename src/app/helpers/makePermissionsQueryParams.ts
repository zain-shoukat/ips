const makePermissionsQueryParams = (
    queryParams: any,
    alias: string,
  ) => {
    let query = '';
    ...
    if (queryParams.authorizationLevel) {
        queryParts.push(`${alias}.authorizationLevel = :authorizationLevel`);
        params['authorizationLevel'] = queryParams.authorizationLevel; 
      }
  ...
  export { makePermissionsQueryParams as MakePermissionsQueryParams };
